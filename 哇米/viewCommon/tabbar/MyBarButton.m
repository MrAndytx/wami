...
- (void)setIsSelect:(BOOL)isSelect
{
    ...
    if (_isSelect)
    {
        ...
        _titleLab.textColor = KLColor(251, 102, 0);
    }
    else
    {
        _imgView.image = _item.image;
        _titleLab.textColor = KLColor(153, 153, 153);
    }
}
...
- (void)layoutSubviews
{
    ...
    _imgView.frame = CGRectMake(0, 10, 22, 22);
    _imgView.center = CGPointMake(selfW/2, selfH/4+5);
    _titleLab.frame = CGRectMake(0, selfH/2, selfW, selfH/2);
}
