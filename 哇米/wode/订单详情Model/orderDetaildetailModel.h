...
@protocol orderDetaildetailModel <NSObject>


@end

@interface orderDetaildetailModel : JSONModel
...
@property (nonatomic,strong) NSString<Optional> *goods_pic;//图片
@end
